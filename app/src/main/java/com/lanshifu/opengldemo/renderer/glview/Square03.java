...
public class Square03 {
    ...
    private static final String TAG = "Square03";
    // 顶点着色器的代码
...
//    }
    ...
    private void initShder() {
        ...
        Log.d(TAG, "initShder: vPositionHandle="+vPositionHandle);
        Log.d(TAG, "initShder: mMVPMatrixHandle="+mMVPMatrixHandle);
        Log.d(TAG, "initShder: maTexCoordHandle="+maTexCoordHandle);
        Log.d(TAG, "initShder: hChangeType="+hChangeType);
        Log.d(TAG, "initShder: hChangeColor="+hChangeColor);
        Log.d(TAG, "initShder: uXY="+uXY);
    }
